...
const inputFieldStyle = tva({
  base: 'flex-1 text-foreground text-base md:text-sm py-1 h-full placeholder:text-muted-foreground  web:outline-none ios:leading-[0px] web:cursor-text web:data-[disabled=true]:cursor-not-allowed',
});
